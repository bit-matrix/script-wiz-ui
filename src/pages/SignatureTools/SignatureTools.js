...
export const SignatureTools = () => {
  ...
  const [uncompressedPublicKey, setUncompressedPublicKey] = useState();
  const [signMessage, setSignMessage] = useState('');
  const [signSignature, setSignSignature] = useState();
  const [derEncodedSignature, setDerEncodedSignature] = useState();
  const [signAlgorithm, setSignAlgorithm] = useState('ECDSA');
  ...
  const [verifyResultNumber, setVerifyResultNumber] = useState();
          ...
          <div className="signature-tools-result-text">
            ...
            <div className="signature-tools-result-item">
              ...
              <Input
                ...
                type="text"
                value={signMessage}
                onChange={(value) => setSignMessage(value.replace(/\s/g, ''))}
              />
            ...
            <div className="signature-tools-result-item">
              ...
              <Input
                ...
                onChange={(value) => setVerifySignature(value.replace(/\s/g, ''))}
              />
            ...
            <div className="signature-tools-result-item">
              ...
              <Input
                ...
                type="text"
                value={verifyMessage}
                onChange={(value) => setVerifyMessage(value.replace(/\s/g, ''))}
              />
            ...
            <div className="signature-tools-result-item">
              ...
              <Input
                ...
                onChange={(value) => setVerifyPublicKey(value.replace(/\s/g, ''))}
              />
