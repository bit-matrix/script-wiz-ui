...
export const SponsorModal: React.FC<SponsorModalProps> = ({ show, close }) => {
    ...
    return (
        <Modal size="sm" show={show} backdrop={false} onHide={close}>
            <Nav
                activeKey={activeSponsorType}
                appearance="subtle"
                onSelect={sponsorType => setActiveSponsorType(sponsorType)}
            >
